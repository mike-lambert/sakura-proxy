 ...
 */
public class Tor {
    public interface TorFaultCallback {
        void onTorBootstrapFailed(String message);
    }
    ...
    public static void notifyStartupFailed(String message) {
        if (torFaultCallback != null) {
            torFaultCallback.onTorBootstrapFailed(message);
        }
    }

    public static void setTorFaultCallback(TorFaultCallback callback) {
        torFaultCallback = callback;
    }
}
