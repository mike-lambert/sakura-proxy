...
import com.runjva.sourceforge.jsocks.SocksException;
import com.runjva.sourceforge.jsocks.SocksSocket;
...
public class SocksTest implements Runnable{
   ...
   public static void main(String args[]){
	 ...
	 try{
	     ...
	     com.runjva.sourceforge.jsocks.Proxy.setDefaultProxy(proxyHost,proxyPort,"KOUKY001");
	     //Proxy.setDefaultProxy(proxyHost,proxyPort);
	     com.runjva.sourceforge.jsocks.Proxy.getDefaultProxy().setDirect(InetAddress.getByName("localhost"));
